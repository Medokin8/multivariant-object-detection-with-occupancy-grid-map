...
TOPIC = "/laser_scan"  # "/pioneer1/scan"
FRAME_ID = "sim_lidar"  # "pioneer1/laser"
...
class LaserListenerNode(Node):
    ...
    def divide_blobs(self, segment_list):
        ...
        for unique_point, source_segment in single_point_segments:
            most_similar_segment = self.find_most_similar_segment(source_segment, output_segments)
    ...
    def check_for_changes(self):
        ...
        binary_map = np.where(difference_map > TOLERANCE, 1, 0)
